...
test("ai_agent can read approved operational data but cannot mutate SmetaOffice", { timeout: 20_000 }, async () => {
  ...
  const database = {
    projects: [
      {
        ...
        tasks: [{ id: "TASK-1", name: "Test task", status: "Новая" }],
        sections: [],
      },
    ],
    ...
    partners: [],
    salesLeads: [{ id: "LEAD-1", clientName: "Test lead", region: "Чеченская Республика" }],
    salesDeals: [],
    salesActivities: [],
    salesEscalations: [],
    projectHandoffs: [],
    salesKpiSnapshots: [],
    financialPeriods: [{ id: "FIN-1", region: "Чеченская Республика", revenue: 1_000_000 }],
    operationalExpenses: [],
    cashAccounts: [],
    directories: {},
